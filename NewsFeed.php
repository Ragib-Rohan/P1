...
<div class="container-fluid " id="newsfeedname" >
    ...
    $sql="SELECT * FROM newsfeed ORDER BY orderPost DESC";
        ...
        while($row=mysqli_fetch_assoc($result)){
            ...
            <div class="row ">
             ...
             <h6>Date - '.$row["Pdate"].'</h6>
                ...
                <div class="col-lg-6 ">
                    <h2>'.$row["titlePost"].'</h2>
                    <img src="newsfeedA/n.png" class="imgg" alt="">
                    <p>'.$row["post"].'</p>
                </div>';
                ...
                <form action=''>
                    ...
                    <textarea name='message' id='ta'></textarea><br>
                    <button name='' type='submit' class='cmtbtn'>Comment</button>
                </form>
                <hr>
            </div>
